...
Obtain the enrichment scores on China and from China, removing Africa from the analysis.
...
Then for World-1, Asia-1, Mid-East and Europe-3, we fit a linear regression model on each country group.
