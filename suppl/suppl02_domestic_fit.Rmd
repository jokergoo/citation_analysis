...
In this document, we will prove when there is a positive domestic enrichment, $a_1 + a_2 > 1$ and it results in the decrease
...
**Scenario 2**: The second regression is significant. Let's assume there is the following relation where $p$ is dependent on $\log m$. Note for simplicity we 
...
where $w$ is slop coefficient from the linear fit ($w = 0.01495$ from the fitting).
